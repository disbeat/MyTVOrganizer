...
public class PersistentOntology {
	...
	// NEW STUFF
	public static DatatypeProperty tvDotComVotes, tvDotComRating, classification, started, video, roleName;
	
	//public static DatatypeProperty showLink;
	
	public static ObjectProperty season;
	public static ObjectProperty episode;
	// NEW STUFF
	public static ObjectProperty cast, actor, role, playedBy, plays;
	...
	public void loadProperties(ModelMaker maker, String modelID){
		...
		// NEW STUFF
		//tvDotComVotes = m.getDatatypeProperty(NS + "voteCount");
		//tvDotComRating = m.getDatatypeProperty(NS + "airDate");
		roleName =  m.getDatatypeProperty(NS + "roleName");
		biography = m.getDatatypeProperty(NS + "biography");
		birthDay = m.getDatatypeProperty(NS + "birthDay");
		birthPlace = m.getDatatypeProperty(NS + "birthPlace");
		gender = m.getDatatypeProperty(NS + "gender");
		airTime = m.getDatatypeProperty(NS + "airTime");
		classification = m.getDatatypeProperty(NS + "classification");
		started = m.getDatatypeProperty(NS + "started");
		video = m.getDatatypeProperty(NS + "video");
		roleName = m.getDatatypeProperty(NS + "roleName");
		genre = m.getDatatypeProperty(NS + "genre");
		
		cast = m.getObjectProperty(NS + "cast");
		actor = m.getObjectProperty(NS + "actor");
		role = m.getObjectProperty(NS + "roleplay");
		playedBy = m.getObjectProperty(NS + "playedBy");
		plays = m.getObjectProperty(NS + "plays");
		
		//showLink = m.getDatatypeProperty(NS + "showLink");
		//premiered = m.getDatatypeProperty(NS + "premiered");
		//ended = m.getDatatypeProperty(NS + "ended");
	}
